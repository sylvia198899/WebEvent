<%@ Page Language="C#" AutoEventWireup="true" CodeFile="complete.aspx.cs" Inherits="BuyPoint_complete" %>
...
<div class="content">
  ...
  <h2 style="text-align:center">「元寶」兌換成功，您可以至遊戲中的確認領您所兌換的「元寶」，<Br />
    若有任何問題請至客服留言板反應，謝謝！&nbsp;</h2>
  ...
  <div class="btn">
    <asp:ImageButton ID="btn_continue" runat="server" 
        ImageUrl="../images/btn/btn_continue.jpg" width="160" height="47" 
        style="margin-right:25px" 
        onmouseover="MM_swapImage('btn_continue','','../images/btn/btn_continue_o.jpg',1)" 
        onmouseout="MM_swapImgRestore()" onclick="btn_continue_Click"/>
    <asp:ImageButton ID="btn_index" runat="server" 
        ImageUrl="../images/btn/btn_index.jpg" width="160" height="47" 
        style="margin-right:25px" 
        onmouseover="MM_swapImage('btn_index','','../images/btn/btn_index_o.jpg',1)" 
        onmouseout="MM_swapImgRestore()" onclick="btn_index_Click" />
</div>
